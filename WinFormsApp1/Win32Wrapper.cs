...
namespace WallpaperWindow {
    public class W32 {
        ...
        public const int PROCESS_ALL_ACCESS = (int)0x000F0000L;
        ...
        public static extern IntPtr SendMessage(IntPtr hWnd, UInt32 Msg, nint wParam, IntPtr lParam);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        public static extern bool GetClassInfoEx(IntPtr hInstance, string lpszClass, out WNDCLASSEX lpWndClass);

        [DllImport("user32.dll", SetLastError = true)]
        public static extern bool SetClassLongPtr(IntPtr hWnd, int nIndex, IntPtr dwNewLong);
        ...
        public static string GetWindowClass(IntPtr hwnd) {
            ...
            GetClassName(hwnd, classNameBuffer, maxClassNameLength);
            return new string(classNameBuffer);
        }
